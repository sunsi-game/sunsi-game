...
게임 클라이언트 개발자를 목표로  
**게임 제작, 그래픽스, XR/AR 프로젝트**를 중심으로 경험을 쌓아왔습니다.

---

### 🎮 2026
- [언리얼 블루프린트 기반 **공포게임 제작**](https://github.com/sunsi-game/Chilla-s-art)
- [C++ 기반 콘솔 게임 제작 **(Pong)**](https://github.com/sunsi-game/Pong)
...
### 🚀 2024
- [**스마일게이트 게임잼**](https://github.com/sunsi-game/game_jam)
- [**학업 관리 앱 개발**(프론트엔드 담당)](https://github.com/sunsi-game/NAMU-FE)
- [**이미지 트래킹 AR 앱 개발**(메타버스 개발자 경진대회)](https://github.com/sunsi-game/HoloAssist)
   

### 💻 2023
- [**WebGL Scene Graph**(컴퓨터 그래픽스 프로젝트)](https://github.com/sunsi-game/WebGL-Scene-Graph)  
- [**치매 예방 게임 개발**( 한이음 프로보노)](https://github.com/sunsi-game/23_PF)
