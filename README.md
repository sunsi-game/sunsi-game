...
<div align="left">
 📝 2026
 <p> 언리얼 블루프린트 기반 게임 제작 (공포 게임) </p>
 <p> CPP 기반 콘솔 게임 제작 (Pong) </p>
 <p> CPP 기반 콘솔 게임 제작 (MARIO) </p>

  📝 2025
 <p> 홀로렌즈 2 앱 개발(홀로그램 그래픽 연구실) </p>

  📝 2024
 <p> 스마일 게이트 게임잼 </p>
 <p> 학업 관리 앱 개발_프론트 담당(캡스톤 디자인 2) </p>
 <p> 이미지 트래킹 AR 앱 개발(메타버스 개발자 경진대회) </p>

  📝 2023
 <p> WebGL Scene Grap (컴퓨터 그래픽스) </p>
 <p> 치매 예방 게임 개발 (한이음_프로보노 멘토링) </p>
</div>
